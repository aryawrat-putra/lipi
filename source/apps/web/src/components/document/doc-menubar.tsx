    ...
    return (
        <Menubar>
            <MenubarMenu>
                ...
                <MenubarContent>
                    <MenubarItem><FilePlusCorner /> New Tab</MenubarItem>
