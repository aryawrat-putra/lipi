...
import { FileExclamationPoint, Trash, } from "lucide-react";
import { DocumentT } from "../../../../config/types";
import DocumentCard from "../../../../components/document/document-card";
import DeletedDocumentCard from "../../../../components/document/deleted-document-card";
  ...
  if (initialTrashDocs.length > 1) {
    ...
    return (
      <Empty className="my-16">
        <EmptyHeader>
          <EmptyMedia variant="icon"><FileExclamationPoint /></EmptyMedia>
